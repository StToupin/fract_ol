										...
										int max_iterations)
{
	...
	{
		ctemp = complex_add(complex_multiply(
								complex_add(complex_multiply(c, c), c),
								complex_inv(complex_ln(c))), jp);
